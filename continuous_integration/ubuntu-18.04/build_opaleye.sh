...
docker buildx build --cache-to=type=local,dest=cache --cache-from=type=local,src=cache --platform linux/amd64 --output=type=local,dest=opaleye-ci_18.04.tar.gz -t suburbanmarine/opaleye-ci:18.04 .
