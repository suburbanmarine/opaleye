...
# docker buildx build --cache-to=type=local,dest=../cache --cache-from=type=local,src=../cache --platform linux/amd64 --output=type=image,push=true -t suburbanmarine/opaleye-ci:18.04 .
docker build -t suburbanmarine/opaleye-ci:18.04 .
