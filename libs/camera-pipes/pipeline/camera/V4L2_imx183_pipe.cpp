...
bool V4L2_imx183_pipe::init(const char name[])
{
  ...
  switch(m_fourcc)
  {
    case PIX_FMT_RG12:
    {
      m_src_caps= gst_caps_from_string("video/x-raw, format=rg12, framerate=0/1, max-framerate=20/1, pixel-aspect-ratio=1/1, width=2464, height=2056, interlace-mode=progressive, colorimetry=sRGB");
      break;
    }
    default:
    {
